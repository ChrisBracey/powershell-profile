...
############                       https://github.com/ChrisBracey/powershell-profile.git.                         ############
############                                                                                                         ############
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
############                                                                                                         ############
...
function Update-Profile {
    try {
        $url = "https://raw.githubusercontent.com/ChrisBracey/powershell-profile/master/Microsoft.PowerShell_profile.ps1"
...
if (-not $debug -and `
    ...
    Write-Warning "Skipping PowerShell and Profile update in debug mode"
}
